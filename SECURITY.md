...
- Does not make network requests itself. However, SCIP indexers and type-checkers invoked via `npx`, `bunx`, or `uvx` may download tooling on first run if not already cached locally.
